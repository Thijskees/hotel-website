...
<head>
    ...
    <link rel="stylesheet" href="/styling/over-ons2.css">
...
<?php include("../assets/html/navbar.html"); ?>
    ...
    <div class="hero-container">
        <div class="hero-content-wrapper">
            ...
            <p id="dark2">Bij Hotel De Zonne Vallei streven we ernaar om elke gast een onvergetelijke ervaring te bieden, doordrenkt met luxe, comfort en uitzonderlijke gastvrijheid. Gelegen in het hart van Alkmaar, biedt ons hotel de perfecte uitvalsbasis om deze historische en charmante stad te ontdekken.</p>  <!-- tesk opmaak verbetern-->
